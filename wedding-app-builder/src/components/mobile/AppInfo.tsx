...
//         onClick={onToggle}
//         disabled={disabled}
//         className={`relative inline-flex h-[20px] w-[40px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 ${checked ? "bg-pink-500" : "bg-gray-300"} ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}
//     >
//         <span
...
//             saveFormToFirestore(user, form)
//                 .then(() => console.log("Form autosaved"))
...
//     return (
//         <main className="min-h-screen bg-[#0D0208] text-[#E4D7DE] flex">
//             <aside className="w-60 bg-[#1A1A1A] border-r border-pink-400 p-4 space-y-3 text-[#F5EAF3]">
//                 <div>
//                     <h1 className="text-xl font-bold text-pink-500 mb-4">WedDesigner Builder</h1>
...
//             onClick={() => setStep(idx)}
//             className={`w-full justify-start ${step === idx ? "bg-purple-500 text-black font-semibold" : "font-semibold hover:text-pink-400"}`}
//         >
//             {item.label}
//         </Button>
//     ))}
// </div>
//                 </div>
//                 <div className="absolute bottom-16 w-full flex justify-left gap-2">
//                     <Button
//                         variant="outline"
//                         className="bg-[#1A1A1A] text-white border border-gray-500 hover:bg-gray-800 px-4 py-2 rounded-md text-sm"
//                         onClick={() => router.push("/designer-settings")}
//                     >
...
//                         className="bg-pink-500 text-black px-6 py-2 font-bold rounded-md text-sm"
//                     >
//                         Log Out
//                     </Button>
//                 </div>
...
//             <section className="flex-1 p-10 space-y-6 bg-[#0D0208] text-[#E4D7DE]">
...
//                         <div>
//                             <Label className="text-pink-300 pb-2 font-bold">Couple Name</Label>
//                             <Input
...
//                         </div>
//                         <div>
//                             <Label className="text-pink-300 pb-2 font-bold">Wedding Date</Label>
//                             <Input
//                                 type='date'
//                                 className="[color-scheme:dark] bg-[#1A1A1A] text-white border border-pink-300"
...
//                         </div>
//                         <div>
//                             <Label className="text-pink-300 pb-2 font-bold">Wedding Location</Label>
//                             {/* <LocationAutocomplete
//                                 value={form.weddingLocation}
//                                 onChange={(val) => handleChange("weddingLocation", val)}
//                             /> */}
//                             <Input
//                                 className="bg-[#1A1A1A] text-white border border-pink-300"
//                                 value={form.weddingLocation}
...
//                         goNext={goNext}
//                         goBack={goBack}
//                         form={form} // pass the whole form object
//                     />
//                 )}
...
export default function Home() {
    ...
    return (
        <main className="min-h-screen bg-[#0D0208] text-[#E4D7DE] flex flex-col lg:flex-row">
            <button
            ...
            <aside className={`fixed z-40 lg:static top-0 left-0 bg-[#1A1A1A] text-[#F5EAF3] w-64 h-screen transform transition-transform duration-300 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>

                <div className="p-4 space-y-4 flex flex-col h-full">
                    <h1 className="text-xl font-bold text-pink-500">WedDesigner Builder</h1>
                    <div className="space-y-2">
                        {sidebarItems.map((item, idx) => (
                            <Button
                                key={item.key}
                ...
                {sidebarItems[step]?.key === "appInfo" && (
                    <div className="max-w-2xl space-y-6">
                        ...
                        <div>
                            <Label className="text-pink-300 pb-2 font-bold">Couple Name</Label>
                            <Input
                                className="w-full bg-[#1A1A1A] text-white border border-pink-300 px-4 py-2"
                                value={form.coupleName}
                                onChange={(e) => handleChange("coupleName", e.target.value)}
                                disabled={isSubmitted}
                            />
