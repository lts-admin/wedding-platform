...
//                                 />
//                             </div>
//                             <h3 className="text-2xl font-semibold text-pink-400 mb-2 pt-6">Simplify Notifications </h3>
//                             <p className="text-sm text-[#E4D7DE] max-w-xs text-center">
...
//                                 />
//                             </div>
//                             <h3 className="text-2xl font-semibold text-pink-400 mb-2 pt-6">Your App’s Journey</h3>
//                             <p className="text-sm text-[#E4D7DE] max-w-xs text-center">
//                                 Stay in the loop from start to finish with a transparent progress tracker.
//                             </p>
//                         </motion.div>
//                     </div>
//                 </div>
    ...
    const features = [
        {
            ...
            description: "Design your wedding app with simplicity. Choose fonts, colors, and layouts."
        },
        {
        ...
        },
        {
            ...
            title: "Simplify Notifications",
            description: "Real-time updates, real-time satisfaction."
        },
        {
            image: "/assets/my_account.png",
            title: "Your App’s Journey",
            description: "Stay in the loop from start to finish with a transparent progress tracker."
        },
    ];
